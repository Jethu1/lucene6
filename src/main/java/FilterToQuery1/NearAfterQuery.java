...
public class NearAfterQuery extends Query {
    ...
    public NearAfterQuery(String field, String[] items, int slop, boolean inOrder) {
    ...
    public Weight createWeight(IndexSearcher searcher, boolean needsScores) throws IOException {
        return new NearAfterQuery.NearAfterWeight(searcher, needsScores);
    }
    ...
    final class NearAfterWeight extends Weight {

        private final boolean needsScores;

        public NearAfterWeight(IndexSearcher searcher, boolean needsScores) throws IOException {
            super(NearAfterQuery.this);
        ...
        public Scorer scorer(LeafReaderContext context) throws IOException {
            ...
            //寻找匹配的长词--开始：
            Terms terms = context.reader().terms(NearAfterQuery.this.field);
            if (terms == null) {
                return null;
            }
