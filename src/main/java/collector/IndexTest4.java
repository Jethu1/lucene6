...
public class IndexTest4 {
    ...
    public void index() throws IOException {
        ...
        Directory directory = FSDirectory.open(Paths.get("300index"));
...
//        indexWriter.forceMerge(5);
        ...
        for (int m = 0; m < 3000; m++) {
            for (int i = 0; i < 100; i++) {
                ...
                doc[10*i].add(new NumericDocValuesField("IntV", NumericUtils.floatToSortableInt(2.5f)));
                doc[10*i].add(new FloatPoint("IntV",2.5f));
                doc[10*i].add(new StoredField("IntV",2.5f));
                ...
                doc[10*i+1].add(new NumericDocValuesField("IntV",NumericUtils.floatToSortableInt(3.5f)));
                doc[10*i+1].add(new FloatPoint("IntV",3.5f));
                doc[10*i+1].add(new StoredField("IntV",3.5f));
                ...
                doc[10*i+2].add(new NumericDocValuesField("IntV",NumericUtils.floatToSortableInt(4.5f)));
                doc[10*i+2].add(new FloatPoint("IntV",4.5f));
                doc[10*i+2].add(new StoredField("IntV",4.5f));
                ...
                doc[10*i+3].add(new NumericDocValuesField("IntV",NumericUtils.floatToSortableInt(5.5f)));
                doc[10*i+3].add(new FloatPoint("IntV",5.5f));
                doc[10*i+3].add(new StoredField("IntV",5.5f));
                ...
                doc[10*i+4].add(new NumericDocValuesField("IntV",NumericUtils.floatToSortableInt(6.5f)));
                doc[10*i+4].add(new FloatPoint("IntV",6.5f));
                doc[10*i+4].add(new StoredField("IntV",6.5f));
                ...
                doc[10*i+5].add(new NumericDocValuesField("IntV", NumericUtils.floatToSortableInt(7.5f)));
                doc[10*i+5].add(new FloatPoint("IntV",7.5f));
                doc[10*i+5].add(new StoredField("IntV",7.5f));
                ...
                doc[10*i+6].add(new NumericDocValuesField("IntV",NumericUtils.floatToSortableInt(8.5f)));
                doc[10*i+6].add(new FloatPoint("IntV",8.5f));
                doc[10*i+6].add(new StoredField("IntV",8.5f));
                ...
                doc[10*i+7].add(new NumericDocValuesField("IntV",NumericUtils.floatToSortableInt(9.5f)));
                doc[10*i+7].add(new FloatPoint("IntV",9.5f));
                doc[10*i+7].add(new StoredField("IntV",9.5f));
                ...
                doc[10*i+8].add(new NumericDocValuesField("IntV", NumericUtils.floatToSortableInt(10.5f)));
                doc[10*i+8].add(new FloatPoint("IntV",10.5f));
                doc[10*i+8].add(new StoredField("IntV",10.5f));
                ...
                doc[10*i+9].add(new NumericDocValuesField("IntV", NumericUtils.floatToSortableInt(11.5f)));
                doc[10*i+9].add(new FloatPoint("IntV",11.5f));
                doc[10*i+9].add(new StoredField("IntV",11.5f));
